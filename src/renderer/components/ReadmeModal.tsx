            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
              ...
              <div className="p-3 rounded-xl bg-white/[0.03] border border-white/[0.06] space-y-1">
                ...
                <p className="text-xs text-text-secondary leading-relaxed">
                  複数枚をまとめて処理するとき、出力サイズを揃えます。余白のある側が画像ごとに異なっていても、各画像はそれぞれの余白を正しく削った上でサイズだけが揃います。揃える相手は元の寸法が同じ画像どうしに限られるため、表紙と本文のように判型の違うものが混ざっていても、互いのサイズに引きずられることはありません。統一後の寸法はプレビューに表示されるため、書き出す前に確認できます。「切り出し位置も揃える」を有効にすると、全画像をまったく同じ座標で切り抜きます。
                </p>
              </div>
